...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const unlisten = history(handleLocationChange);
      ...
      <header className={styles.header}>
        <Slider {...settings}>
          <div className={styles.header__slider}>
            <img
              className={styles["header__slider--img"]}
              src={headerImg1}
              alt="imagen slider header 1"
              loading="lazy"
            />
            <section className={styles.header__section}>
              <div
                className={`${styles.header__info} slide ${
              ...
              >
                ...
                <p className={styles.header__title}>
                  "Rescatando patitas, salvando corazones"
                </p>
          ...
          <div className={styles.header__slider}>
            <img
              className={`${styles["header__slider--img"]} ${styles["slider__img--two"]}`}
              src={headerImg2}
              alt="imagen slider header 2"
              loading="lazy"
            />
            <div className={styles["header__slider--overlay"]}>
              ...
              >
                <div className={styles["header__info-heading"]}>
                  <img
                    className={styles["header__info--img"]}
                    src={LogoPatita}
                    alt="logo patita"
                    loading="lazy"
                  />
                ...
                <p className={styles["header__info--text"]}>
                  Nos encargamos de difundir, listar y dar mayor visibilidad a
                  mascotas perdidas y en busca de un nuevo hogar
                </p>
              </div>
            </div>
          </div>
          <div className={styles.header__slider}>
            <img
              className={`${styles["header__slider--img"]} ${styles["slider__img--three"]}`}
              src={headerImg3}
              alt="imagen slider header 3"
            />
            <div className={styles["header__slider--overlay"]}>
              <div
                className={`${styles.header__info} slide ${
              ...
              >
                ...
                <p className={styles["header__info--text"]}>
                  Somos un equipo de desarrollo el cual compartimos la necesidad
                  de ayudar a los animales que día a día nos brindan su amor
                  incondicional
                </p>
              </div>
            </div>
